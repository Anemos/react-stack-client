...
const NewssadAccordion = props => {
 ...
 return (
    <div style={{ width: "100%", margin: "0 auto" }}>
     <h3 style={{textAlign: "center", margin: "10px auto auto"}}> 슬픈 뉴스 TOP5 </h3>
...
<Image src={item.news_photo_src} className="thumbnail" thumbnail />
    ...
    <Col xs={10} md={10} lg={10}>
      <Badge pill variant="danger">{item.sad}</Badge>{' '}{item.news_title}
    </Col>
  </Row>
</Container>
               </Accordion.Toggle>
...
export default NewssadAccordion;