...
const NewsangryAccordion = props => {
 const { movies } = props;
 const style = {
    color: "red",
    fontSize: 10,
 ...
 return (
    <div style={{ width: "100%", margin: "0 auto" }}>
     <h3 style={{textAlign: "center", margin: "10px auto auto"}}> 화나는 뉴스 TOP5 </h3>
...
<Image src={item.news_photo_src} className="thumbnail" thumbnail />
    ...
    <Col xs={10} md={10} lg={10}>
      <Badge pill variant="warning">{item.angry}</Badge>{' '}{item.news_title}
    </Col>
  </Row>
</Container>
               </Accordion.Toggle>
...
export default NewsangryAccordion;